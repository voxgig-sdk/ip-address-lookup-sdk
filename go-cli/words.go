...
func registerSDKWords(r *eng.Registry, client *sdk.IpAddressLookupSDK) {
...
func runOp(client *sdk.IpAddressLookupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
