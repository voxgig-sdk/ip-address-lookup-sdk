...
AQL-driven CLI and REPL for the IpAddressLookup SDK. Positional arguments are
...
```sh
go build -o ip-address-lookup-cli ./...
```
...
./ip-address-lookup-cli list get_ip_address
./ip-address-lookup-cli load 1 get_ip_address
./ip-address-lookup-cli load '{id:1}' get_ip_address
