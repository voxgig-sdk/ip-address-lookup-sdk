...
type IpAddressLookupSDK struct {
	Mode     string
...
func (sdk *IpAddressLookupSDK) OptionsMap() map[string]any {
...
func (sdk *IpAddressLookupSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpAddressLookupSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpAddressLookupSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpAddressLookupSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpAddressLookupSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpAddressLookupSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpAddressLookupSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpAddressLookupSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpAddressLookupSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpAddressLookupSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpAddressLookupSDK {
	...
	sdk := NewIpAddressLookupSDK(sdkopts)
	sdk.Mode = "test"
