...
type GetIpAddressEntity struct {
	name    string
	client  *core.IpAddressLookupSDK
...
func NewGetIpAddressEntity(client *core.IpAddressLookupSDK, entopts map[string]any) *GetIpAddressEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetIpAddressEntity) GetName() string { return e.name }
...
func (e *GetIpAddressEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetIpAddressEntity) Deleted() bool {
	return e.deleted
}


func (e *GetIpAddressEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetIpAddressEntity(e.client, opts)
}

func (e *GetIpAddressEntity) Data(args ...any) any {
...
func (e *GetIpAddressEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetIpAddress; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetIpAddressEntity) DataTyped(data ...GetIpAddress) GetIpAddress {
	if len(data) > 0 {
		return typedFrom[GetIpAddress](e.Data(asMap(data[0])))
	}
	return typedFrom[GetIpAddress](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetIpAddress (all fields
// optional at the wire level).
func (e *GetIpAddressEntity) MatchTyped(match ...GetIpAddress) GetIpAddress {
	if len(match) > 0 {
		return typedFrom[GetIpAddress](e.Match(asMap(match[0])))
	}
	return typedFrom[GetIpAddress](e.Match())
}
...
func (e *GetIpAddressEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetIpAddressEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetIpAddressLoadMatch and returns an GetIpAddress. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetIpAddressEntity) LoadTyped(reqmatch GetIpAddressLoadMatch, ctrl map[string]any) (GetIpAddress, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetIpAddress{}, err
	}
	return typedFrom[GetIpAddress](res), nil
}



func (e *GetIpAddressEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetIpAddressEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetIpAddressEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetIpAddressEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetIpAddressEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
