...
describe("GetIpAddressDirect", function()
  it("should direct-load-get_ip_address", function()
    local setup = get_ip_address_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_ip_address", setup.live and "live" or "unit")
