...
function runner.env_override(m)
  local live = runner.getenv("IPADDRESSLOOKUP_TEST_LIVE")
  local override = runner.getenv("IPADDRESSLOOKUP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPADDRESSLOOKUP_TEST_EXPLAIN")
