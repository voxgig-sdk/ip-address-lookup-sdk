...
description = {
  ...
  homepage = "https://github.com/voxgig-sdk/ip-address-lookup-sdk",
  issues_url = "https://github.com/voxgig-sdk/ip-address-lookup-sdk/issues",
  license = "MIT",
  labels = { "voxgig", "sdk", "generated-sdk", "openapi", "api-client", "ip-address-lookup" }
}
dependencies = {
  "lua >= 5.3",
  "dkjson >= 2.5",
