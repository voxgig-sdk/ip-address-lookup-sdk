...
local GetIpAddressEntity = {}
GetIpAddressEntity.__index = GetIpAddressEntity


function GetIpAddressEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetIpAddressEntity)
  self._name = "get_ip_address"
  self._client = client
...
function GetIpAddressEntity:get_name()
  return self._name
end


function GetIpAddressEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetIpAddressEntity.new(self._client, opts)
end
...
function GetIpAddressEntity:mark_deleted()
  self._deleted = true
end


function GetIpAddressEntity:deleted()
  return true == self._deleted
end


function GetIpAddressEntity:data_set(args)
  if args ~= nil then
...
function GetIpAddressEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetIpAddressEntity:match_set(args)
  if args ~= nil then
...
function GetIpAddressEntity:match_get()
...
function GetIpAddressEntity:stream(action, args, callopts)
...
---@param reqmatch GetIpAddressLoadMatch
---@param ctrl? table
---@return GetIpAddress
---@return string? err
function GetIpAddressEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetIpAddressEntity:_run_op(ctx, post_done)
  local utility = self._utility
