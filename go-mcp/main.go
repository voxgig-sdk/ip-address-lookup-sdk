// Command IpAddressLookup-mcp is an MCP server exposing the IpAddressLookup
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpAddressLookup_list  — list records of an entity
//	IpAddressLookup_load  — load a single record of an entity
//
