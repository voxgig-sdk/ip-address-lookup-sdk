...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_ip_address"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpAddressLookupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-address-lookup_list",
		Description: "List records from IpAddressLookup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-address-lookup_load",
		Description: "Load a single record from IpAddressLookup. " +
...
func runOp(client *sdk.IpAddressLookupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpAddressLookupSDK, name string) (sdk.IpAddressLookupEntity, error) {
	switch strings.ToLower(name) {
	case "get_ip_address":
		return client.GetIpAddress(nil), nil
