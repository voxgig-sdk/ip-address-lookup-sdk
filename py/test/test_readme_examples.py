# IpAddressLookup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpAddressLookupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpAddressLookupSDK(...) and IpAddressLookupSDK.test(...) become
#      IpAddressLookupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipaddresslookup_sdk"
_SDK_CLASS = "IpAddressLookupSDK"
