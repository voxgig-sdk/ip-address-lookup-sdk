...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-address-lookup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-address-lookup-sdk \
      --repository voxgig-sdk/ip-address-lookup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-address-lookup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-address-lookup-sdk --id=<id>` removes it.
