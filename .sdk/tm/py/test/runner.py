...
class IpAddressLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpAddressLookupTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpAddressLookupTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpAddressLookupTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
