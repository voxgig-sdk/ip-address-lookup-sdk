...
from projectname_sdk.core.control import IpAddressLookupControl
...
class IpAddressLookupContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpAddressLookupControl()
        ...
        if isinstance(sp, IpAddressLookupSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpAddressLookupResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpAddressLookupResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpAddressLookupOperation({})
    ...
    def make_error(self, code, msg):
        return IpAddressLookupError(code, msg, self)
