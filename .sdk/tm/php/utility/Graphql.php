...
// IpAddressLookup SDK utility: graphql
//
...
class IpAddressLookupGraphql
{
    ...
    // equivalent.
    public static function body(IpAddressLookupContext $ctx): mixed
    {
    ...
    public static function errors(IpAddressLookupContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
