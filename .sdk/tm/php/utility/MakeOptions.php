...
// IpAddressLookup SDK utility: make_options

class IpAddressLookupMakeOptions
{
    ...
    public static function call(IpAddressLookupContext $ctx): array
    {
        ...
        //
        // `IpAddressLookupSchema::optspec()` is built from the model:
        ...
        $optspec = IpAddressLookupSchema::optspec();
