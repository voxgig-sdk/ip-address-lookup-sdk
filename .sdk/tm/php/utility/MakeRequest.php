...
// IpAddressLookup SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpAddressLookupMakeRequest
{
    public static function call(IpAddressLookupContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpAddressLookupResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpAddressLookupResponse($fetched);
        } else {
