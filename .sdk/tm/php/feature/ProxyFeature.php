...
// IpAddressLookup SDK proxy feature
...
class IpAddressLookupProxyFeature extends IpAddressLookupBaseFeature
{
    ...
    public function init(IpAddressLookupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpAddressLookupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
