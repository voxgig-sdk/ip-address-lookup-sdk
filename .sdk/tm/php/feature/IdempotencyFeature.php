...
// IpAddressLookup SDK idempotency feature
...
class IpAddressLookupIdempotencyFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _mutating(IpAddressLookupContext $ctx): bool
    {
