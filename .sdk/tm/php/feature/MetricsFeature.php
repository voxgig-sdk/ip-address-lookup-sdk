...
// IpAddressLookup SDK metrics feature
...
class IpAddressLookupMetricsFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _record(IpAddressLookupContext $ctx, bool $ok): void
    {
