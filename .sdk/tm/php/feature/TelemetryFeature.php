...
// IpAddressLookup SDK telemetry feature
...
class IpAddressLookupTelemetryFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _close(IpAddressLookupContext $ctx, bool $ok): void
    {
