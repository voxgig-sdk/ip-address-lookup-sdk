...
// IpAddressLookup SDK debug feature
...
class IpAddressLookupDebugFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _finish(IpAddressLookupContext $ctx, bool $ok): void
    {
