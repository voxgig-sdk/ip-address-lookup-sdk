...
// IpAddressLookup SDK netsim feature
...
class IpAddressLookupNetsimFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _simulate(IpAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpAddressLookupContext $ctx, array $applied): void
    {
        $client = $this->client;
