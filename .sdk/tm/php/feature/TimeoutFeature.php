...
// IpAddressLookup SDK timeout feature
...
class IpAddressLookupTimeoutFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _with_timeout(IpAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpAddressLookupContext $_ctx, float $ms): void
    {
        $client = $this->client;
