...
// IpAddressLookup SDK cache feature
...
class IpAddressLookupCacheFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _through(IpAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
