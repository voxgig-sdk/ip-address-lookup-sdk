...
// IpAddressLookup SDK rbac feature
...
class IpAddressLookupRbacFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _required(IpAddressLookupContext $ctx): ?string
    {
    ...
    private function _reject(IpAddressLookupContext $ctx, string $required): void
    {
    ...
    private function _track(IpAddressLookupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
