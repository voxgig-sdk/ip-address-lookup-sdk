...
// IpAddressLookup SDK paging feature
...
class IpAddressLookupPagingFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _is_list(IpAddressLookupContext $ctx): bool
    {
