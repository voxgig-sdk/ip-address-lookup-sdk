...
// IpAddressLookup SDK utility type

class IpAddressLookupUtility
{
    ...
    public static function copy(IpAddressLookupUtility $src): IpAddressLookupUtility
    {
        $u = new IpAddressLookupUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
