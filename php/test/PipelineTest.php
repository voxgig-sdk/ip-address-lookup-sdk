...
// IpAddressLookup SDK pipeline test
//
...
require_once __DIR__ . '/../ipaddresslookup_sdk.php';
...
{
    private static function utility(): IpAddressLookupUtility
    {
        return new IpAddressLookupUtility();
    }
    ...
    private static function ctx(array $over = []): IpAddressLookupContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpAddressLookupContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpAddressLookupOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpAddressLookupError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpAddressLookupOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpAddressLookupMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpAddressLookupOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpAddressLookupMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpAddressLookupOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpAddressLookupMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressLookupSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpAddressLookupMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpAddressLookupResponse([]),
            'result' => new IpAddressLookupResult([]),
        ]);
        [, $err] = IpAddressLookupMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec([]),
            'response' => null,
            'result' => new IpAddressLookupResult([]),
        ]);
        [, $err] = IpAddressLookupMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec(['step' => 's']),
            'response' => new IpAddressLookupResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpAddressLookupResult([]),
        ]);
        [, $err] = IpAddressLookupMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec(['step' => 's']),
            'response' => new IpAddressLookupResponse(self::resp(200, ['v' => 1])),
            'result' => new IpAddressLookupResult([]),
        ]);
        [, $err] = IpAddressLookupMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec(['step' => 's']),
            'response' => new IpAddressLookupResponse(self::resp(200, ['v' => 2])),
            'result' => new IpAddressLookupResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupMakeResponse::call($ctx);
    ...
    {
        $preset = new IpAddressLookupResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec([]),
            'response' => new IpAddressLookupResponse([]),
            'result' => new IpAddressLookupResult([]),
        ...
        [$got, $err] = IpAddressLookupMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpAddressLookupResult([])]);
        [, $err] = IpAddressLookupMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpAddressLookupSpec([]), 'result' => null]);
        [, $err] = IpAddressLookupMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressLookupSpec(['step' => 's']),
            'result' => new IpAddressLookupResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpAddressLookupOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressLookupMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpAddressLookupSpec(['step' => 's']),
            'result' => new IpAddressLookupResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpAddressLookupOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpAddressLookupMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpAddressLookupResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpAddressLookupSpec([]),
            'result' => new IpAddressLookupResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpAddressLookupMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressLookupMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpAddressLookupError('boom', 'boom');
        $utility->fetcher = function (IpAddressLookupContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressLookupSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpAddressLookupMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpAddressLookupContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpAddressLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpAddressLookupResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpAddressLookupContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpAddressLookupSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpAddressLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpAddressLookupResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpAddressLookupSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpAddressLookupMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpAddressLookupMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpAddressLookupMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpAddressLookupResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpAddressLookupDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpAddressLookupResult(['ok' => false])]);
        $this->expectException(IpAddressLookupError::class);
        IpAddressLookupDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpAddressLookupResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpAddressLookupMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpAddressLookupMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpAddressLookupBaseFeature();
        $b = new IpAddressLookupBaseFeature();
        IpAddressLookupFeatureAdd::call($ctx, $a);
        IpAddressLookupFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpAddressLookupBaseFeature
    {
        $f = new IpAddressLookupBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpAddressLookupFeatureAdd::call($ctx, self::named_feature('a'));
        IpAddressLookupFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IpAddressLookupFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IpAddressLookupFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IpAddressLookupFeatureAdd::call($ctx, $replace);
        ...
        IpAddressLookupFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpAddressLookupContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpAddressLookupSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpAddressLookupPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpAddressLookupPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpAddressLookupResponse(['headers' => null]),
            'result' => new IpAddressLookupResult([]),
        ]);
        IpAddressLookupResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpAddressLookupResultBody::call($ctx);
