...
// IpAddressLookup SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpAddressLookupOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpAddressLookupOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpAddressLookupOmni::structfix($val, Struct::undef()))) {
