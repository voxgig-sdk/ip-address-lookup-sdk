...
class IpAddressLookupTestRunner
{
    ...
    {
        $live = self::getenv('IP_ADDRESS_LOOKUP_TEST_LIVE');
        $override = self::getenv('IP_ADDRESS_LOOKUP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_ADDRESS_LOOKUP_TEST_EXPLAIN');
...
class_alias('IpAddressLookupTestRunner', 'Runner');
class_alias('IpAddressLookupHelpers', 'Helpers');
