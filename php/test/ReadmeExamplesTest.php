...
// IpAddressLookup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpAddressLookupSDK::test)
...
{
    private const SDK_CLASS = 'IpAddressLookupSDK';
    ...
    private const SDK_BASE = 'ipaddresslookup_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipaddresslookup_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
