...
class IpAddressLookupSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IpAddressLookupHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IpAddressLookupHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!IpAddressLookupFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, IpAddressLookupFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IpAddressLookupUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IpAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IpAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IpAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new IpAddressLookupError($op . "_allow",
                "IpAddressLookupSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IpAddressLookupHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new IpAddressLookupError("graphql_error",
                "IpAddressLookupSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetIpAddress($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_ip_address === null) {
                $this->_get_ip_address = new GetIpAddressEntity($this, null);
            }
            return $this->_get_ip_address;
        }
        return new GetIpAddressEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new IpAddressLookupSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
