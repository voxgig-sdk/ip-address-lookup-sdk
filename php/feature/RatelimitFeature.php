...
// IpAddressLookup SDK ratelimit feature
...
class IpAddressLookupRatelimitFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _acquire(IpAddressLookupContext $ctx): void
    {
    ...
    private function _track(IpAddressLookupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
