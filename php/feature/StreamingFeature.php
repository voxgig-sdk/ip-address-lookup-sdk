...
// IpAddressLookup SDK streaming feature
...
class IpAddressLookupStreamingFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _iterate(IpAddressLookupResult $result): \Generator
    {
    ...
    private function _streamable(IpAddressLookupContext $ctx): bool
    {
