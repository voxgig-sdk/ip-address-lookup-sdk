...
// IpAddressLookup SDK clienttrack feature
...
class IpAddressLookupClienttrackFeature extends IpAddressLookupBaseFeature
{
    ...
    public function PostConstruct(IpAddressLookupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpAddressLookup-SDK';
