...
// IpAddressLookup SDK audit feature
...
class IpAddressLookupAuditFeature extends IpAddressLookupBaseFeature
{
    ...
    private function _emit(IpAddressLookupContext $ctx, string $outcome): void
    {
