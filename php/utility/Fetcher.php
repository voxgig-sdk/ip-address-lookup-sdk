...
// IpAddressLookup SDK utility: fetcher

class IpAddressLookupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpAddressLookupSDK/1.0)';
    ...
    public static function call(IpAddressLookupContext $ctx, string $fullurl, array $fetchdef): array
    {
