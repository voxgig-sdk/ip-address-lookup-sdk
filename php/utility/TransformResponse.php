...
// IpAddressLookup SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpAddressLookupTransformResponse
{
    public static function call(IpAddressLookupContext $ctx): mixed
    {
        ...
        $transform = IpAddressLookupHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
