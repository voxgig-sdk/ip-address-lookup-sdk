...
(0, node_test_1.describe)('GetIpAddressDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpAddressLookupSDK({
    ...
    (0, node_test_1.test)('direct-load-get_ip_address', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_ip_address', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_ADDRESS_LOOKUP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpAddressLookupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_ADDRESS_LOOKUP_TEST_GET_IP_ADDRESS_ENTID'];
    ...
    const client = new __1.IpAddressLookupSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetIpAddressDirect.test.js.map