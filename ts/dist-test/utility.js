...
function envOverride(m) {
    if ('TRUE' === process.env.IP_ADDRESS_LOOKUP_TEST_LIVE ||
        'TRUE' === process.env.IP_ADDRESS_LOOKUP_TEST_OVERRIDE) {
    ...
    m.IP_ADDRESS_LOOKUP_TEST_EXPLAIN = process.env.IP_ADDRESS_LOOKUP_TEST_EXPLAIN || m.IP_ADDRESS_LOOKUP_TEST_EXPLAIN;
    return m;
}
