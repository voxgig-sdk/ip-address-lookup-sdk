...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-address-lookup` | `npm install @voxgig-sdk/ip-address-lookup` |
| Python | `voxgig-sdk-ip-address-lookup` | `pip install voxgig-sdk-ip-address-lookup` |
| PHP | `voxgig-sdk/ip-address-lookup` | `composer require voxgig-sdk/ip-address-lookup` |
| Golang | `github.com/voxgig-sdk/ip-address-lookup-sdk/go` | `go get github.com/voxgig-sdk/ip-address-lookup-sdk/go` |
| Ruby | `voxgig-sdk-ip-address-lookup` | `gem install voxgig-sdk-ip-address-lookup` |
| Lua | `voxgig-sdk-ip-address-lookup` | `luarocks install voxgig-sdk-ip-address-lookup` |
