...
Results: Successful response with IP address and network information.
...
| --- | --- | --- | --- |
| GetIpAddress | `load` | `GET /` | See reference |

## Connect to the API

- Production server: `https://ipty.org`
...
- `ip-address-lookup_list`: List records for an entity. No active entity supports this operation.
- `ip-address-lookup_load`: Load one record for an entity. Supported entities: `get_ip_address`.
