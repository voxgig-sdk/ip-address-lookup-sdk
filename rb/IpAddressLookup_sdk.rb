...
require_relative 'IpAddressLookup_types'
...
class IpAddressLookupSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = IpAddressLookupHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = IpAddressLookupHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, IpAddressLookupFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    IpAddressLookupUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = IpAddressLookupHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = IpAddressLookupHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = IpAddressLookupHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue IpAddressLookupError => err
    ...
    if fetched.is_a?(Hash)
      status = IpAddressLookupHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = IpAddressLookupError.new(
        "graphql_error", "IpAddressLookupSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = IpAddressLookupSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
